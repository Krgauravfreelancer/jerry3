...
namespace DesignImager_UserControl
{
    public partial class DesignImagerUserControl : System.Windows.Controls.UserControl
    {
        private int selectedVideoEvent;
        public DataTable dtVideoSegment;
        public bool UserConsent;
        public DesignImagerUserControl(int selectedVideoEvent)
        {
            InitializeComponent();
