...
namespace AuthenitcationProject
{
    public static class FormUpload
    {
        ...
        private static HttpWebResponse PostForm(string postUrl, string userAgent, string contentType, byte[] formData, string headerkey, string headervalue)
        {
            ...
            // { "X-MAC-Address", "00:00:00:00:00:02" },
             //  { "X-CBU-Access-Key", "6Lwr_)@e{3GVSF58D#JiX4]5)%peA[" },

            //Add header if needed
            request.Headers.Add(headerkey, headervalue);
            request.Headers.Add("X-MAC-Address", "00:00:00:00:00:02");
            request.Headers.Add("X-CBU-Access-Key", "6Lwr_)@e{3GVSF58D#JiX4]5)%peA[");
