...
///                     
///     8. Insert Audio Table for Audio files
...
///          
///     9 . Update Audio Table for Audio files
///         ** converting files to blob (byte[]) and passing
    ...
    public partial class MainWindow : Window
    {
        ...
        private void BtnInsertAudio_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                rowAudio["audio_id"] = -1;
                rowAudio["fk_audio_videoevent"] = ((CBVVideoEvent)cmbVideoEvent.SelectedItem)?.videoevent_id ?? 0;
